                ...
                <div class="col-md-10">
                    <div class="tab-content">
                        <div class="tab-pane active" id="CTDT">
                            <div class="row">
                                <div class="ql_CTDeTai" style="background:white;height:1600px;margin-right:15px;border-radius:3px">
                                    ...
                                    <div class="container" style="width:850px">
                                       ...
                                       <div style="margin-left:250px;">
                                        <button type="button" class="btn btn-lg btn-warning" style="margin-right:90px;position:relative">Phê duyệt</button>
                                    <button type="button" class="btn btn-lg btn-danger" style="position:absolute">Không đồng ý</button>
                                    </div>
