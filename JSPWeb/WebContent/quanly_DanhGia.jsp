                ...
                <div class="col-md-10">
                    <div class="tab-content">
                        <div class="tab-pane active" id="DanhGia">
                            <div class="row">
                                <div class="ql_DanhGia" style="background:white;height:870px;margin-right:15px;border-radius:3px">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>10</td>
                                                    <td><input type="text" id="input" class="form-control" required="required"></td>

                                                </tr>
                                                <tr>
                                                    <td>Mục tiêu đề tài</td>
                                                    <td>15</td>
                                                    <td><input type="text" name="" id="input" class="form-control" value="" required="required"></td>

                                                </tr>
                                                <tr>
                                                    <td>Phương pháp nghiên cứu</td>
                                                    <td>15</td>
                                                    <td><input type="text" name="" id="input" class="form-control" value="" required="required"
                                                            pattern="" title=""></td>
                                    ...
                                    <div class="col-sm-12">
                                        <textarea name="" id="mota" class="form-control" rows="4" required="required"></textarea>
                                    </div>
                                    <button type="submit" value="Submit" style="float:right;height:40px; width:100px;background:#E6F1D8; border: 2px solid #C8E2B1;border-radius:5px; margin:20px 10px 0px 0px;">Đánh giá</button>
                                </div>
                            </div>
                        </div>
