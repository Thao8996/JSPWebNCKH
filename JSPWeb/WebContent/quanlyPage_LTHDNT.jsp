                                            ...
                                            <table class="table table-striped table-hover">
                                                <thead class="thead-default">
                                                    <tr class="success">    
                                                        ...
                                                        <th style="width:330px;">Chọn đề tài</th>
                                                       
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                         <td> <input type="text" name="MaHD" value="HD3" style="width:50px"><br>
                                                        </td>

                                                        <td>
                                                            <select name="ChuTich">
                                                            <option value="A" selected>Nguyễn Văn An</option>
                                                        ...
                                                        <td>
                                                            ...
                                                            <option value="D" selected>Văn D</option>
                                                            <option value="-">Other</option>
                                                            </select>
                                                     </td>
                                                        <td>
                                                          ...
                                                          <td>
                                                             <!--ngày thành lập-->
                                                       <input style="height:25px;" type="date" name="bday" id="start_date" />

                                                            <script>
                                                        document.getElementById('start_date').value = Date();
                                                            </script>
                                                        </td>
                                                        <td><select name="DeTai">
                                                            <option value="A" selected>Rung Rung Và Rung</option>
                                                            <option value="B">A</option>
                                                            <option value="-">Other</option>
                                                            </select></td>                                                                                          
                                                    </tr>     
