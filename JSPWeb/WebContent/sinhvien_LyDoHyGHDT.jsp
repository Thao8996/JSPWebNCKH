						...
						<div class="col-md-10">
							<div class="tab-content">
								<div class="tab-pane active" id="DDHGH" >
									<div class="row">
										<div class="sv_GiaHan" style="background:white;height:550px;margin-right:15px;border-radius:3px">
										...
										<div >
											<label class="col-sm-3" for="mota" style="margin-top:10px; margin-left:10px;">Lý do hủy đề tài </label><br>
											<div class="col-sm-12">
												<textarea type="text" name="mota" class="form-control required mota" placeholder="Lý do cá nhân"  id="" required  data-placement="right" data-trigger="manual" data-content="Bạn cần phải nhập vào trường này" rows="3" required style="margin-left:10px;"></textarea>
											</div>
										</div>
											<div>
