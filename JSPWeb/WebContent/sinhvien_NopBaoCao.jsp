					...
					<div class="tab-content">
						<div class="tab-pane active" id="NopBaoCao">
							<div class="sv_NopBC" style="background:white;height:500px;border-radius:3px;overflow:scroll;">
								...
								<div class="ad_table_qltk" style="margin:0px 5px 0px 5px;">
									<table class="table table-striped table-hover">
										...
										<tbody>
											<tr>
												<td>1/2/2014</td>
												<td><a href="sinhvien_BaoCaoTienDo.jsp">Báo cáo tiến độ 1</a></td>
												<td>Nghiên cứu tình hình</td>

											</tr>
											<tr>
												<td>1/2/2014</td>
												<td><a href="sinhvien_BaoCaoTienDo.jsp">Báo cáo tiến độ 2</a></td>
												<td>Nghiên cứu tình hình</td>

											</tr>
											<tr>
												<td>1/2/2014</td>
												<td><a href="sinhvien_BaoCaoTienDo.jsp">Báo cáo tiến độ 3</a></td>
												<td>Nghiên cứu tình hình</td>
								...
								<button type="button" id="btnUpload" class="btn btn-info" style="float:right; margin-right:10px; margin-top:330px;">Upload</button>
