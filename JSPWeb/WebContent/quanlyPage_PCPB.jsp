                                    ...
                                    <div class="ql_table_dsDeTai">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td id="pcgv">
                                                        <div class="form-group">
                                                            <select>
                                                                <option value="">Phan Văn E</option>
                                                                <option value="">Trần Văn D</option>
                                                                <option value="">Nguyễn Văn C</option>
                                                                <option value="" selected>Lê Văn A</option>
                                                                </select>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>DT2</td>
                                                    <td>Nghiên cứu hack mật khẩu Wifi</td>
                                                    <td>Nguyễn Văn WIFI</td>
                                                    <td><a href="quanly_ChiTiet.jsp">Xem</a></td>
                                                    <td id="pcgv">
                                                        <div class="form-group">
                                                            <select>
                                                                <option value="">Phan Văn E</option>
                                                                <option value="">Trần Văn D</option>
                                                                <option value="" selected>Nguyễn Văn C</option>
